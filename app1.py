...
consolidado=pd.read_csv('consolidado_cantidad_casos_criminalidad_en_comunas_por_anio_mes.csv',sep=";",low_memory=False)
moto=pd.read_csv('hurto_de_moto.csv',sep=";",low_memory=False)
carro=pd.read_csv('hurto_de_carro.csv',sep=";",low_memory=False)
residencia=pd.read_csv('hurto_a_residencia - hurto_a_residencia - hurto_a_residencia - hurto_a_residencia (1).csv',low_memory=False)
